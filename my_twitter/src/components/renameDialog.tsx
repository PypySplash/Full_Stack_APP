...
export default function RenameDialog(props: { open: boolean, onClosed: () => void }) {
  ...
  return (
    <Dialog open={open}>
      ...
      My Component
        ...
        <DialogFooter>
          <Button onClick={onClosed} className="h-8">Cancel</Button>
          <Button onClick={handleSave} className="h-8">Rename</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
